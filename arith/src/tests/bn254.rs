...
#[test]
fn test_field() {
    random_field_tests::<Fr>("M31".to_string());
    // random_inversion_tests::<M31>("M31".to_string());
    random_small_field_tests::<Fr>("M31".to_string());

    random_vectorized_field_tests::<Fr>("Vectorized M31".to_string());
}
