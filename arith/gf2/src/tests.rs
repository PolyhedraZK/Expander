...
use crate::{GF2x128, GF2x512, GF2x64, GF2x8, GF2};
...
fn test_simd_field() {
    ...
    random_field_tests::<GF2x512>("Vectorized GF2 len 512".to_string());
    random_simd_field_tests::<GF2x512>("Vectorized GF2 len 512".to_string());
}
...
fn test_custom_serde_vectorize_gf2() {
    ...
    custom_serde_vectorize_gf2::<GF2x512>()
}
