...
use gkr::{
    ...
    GF2ExtConfigSha2Raw, GoldilocksExtConfigSha2Orion, GoldilocksExtConfigSha2Raw, M31ExtConfigSha2OrionSquare,
...
fn main() {
    ...
    match args.field.as_str() {
        ...
        "goldilocks" => match pcs_type {
            ...
            PolynomialCommitmentType::Orion => match args.circuit.as_str() {
                "keccak" => run_benchmark::<GoldilocksExtConfigSha2Orion>(&args, mpi_config.clone()),
                _ => unreachable!(),
            },
