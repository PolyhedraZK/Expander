...
// PolynomialCommitmentType}; use poly_commit::expander_pcs_init_testing_only;
...
//                 "keccak" => run_benchmark::<M31ExtConfigSha2RawVanilla>(&args,
// mpi_config.clone()),                 "poseidon" =>
// run_benchmark::<M31ExtConfigSha2RawSquare>(&args, mpi_config.clone()),                 _ =>
// unreachable!(),             },
...
//             PolynomialCommitmentType::Raw => match args.circuit.as_str() {
//                 "keccak" => run_benchmark::<GoldilocksExtConfigSha2Raw>(&args,
// mpi_config.clone()),                 _ => unreachable!(),
//             },
...
//             FieldType::GF2 =>
// Circuit::<Cfg::FieldConfig>::load_circuit::<Cfg>(KECCAK_GF2_CIRCUIT),             FieldType::M31
// => Circuit::<Cfg::FieldConfig>::load_circuit::<Cfg>(KECCAK_M31_CIRCUIT),
// FieldType::BN254 => {
