...
//     println!("We are now calculating average throughput, please wait until {N_PROOF} proofs are
// computed");     for i in 0..args.repeats {
...
//         let throughput = (N_PROOF * circuit_copy_size * pack_size *
